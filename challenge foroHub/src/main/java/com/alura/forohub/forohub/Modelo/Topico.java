...
public class Topico {
    ...
    private com.ForoAlura.ForoAlura.Modelo.curso curso;
    @OneToMany(cascade = CascadeType.ALL)
    @JoinColumn(name = "topico_id", referencedColumnName = "id")
    private List<Respuesta> respuestas = new ArrayList<>();

    public Topico(DatosRegistroTopico datos, Usuario autor, com.ForoAlura.ForoAlura.Modelo.curso curso) {
    ...
    public void actualizarDatos(DatosActualizarTopico datosActualizar, Usuario autor, com.ForoAlura.ForoAlura.Modelo.curso curso) {
